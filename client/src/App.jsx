...
import RoomPageWithZegoCloud1 from './pages/Interview/InterviewRoom/RoomPageWithZegoCloud1';
import NewInterviewRoom from './pages/Interview/NewInterviewRoom/NewInterviewRoom';
import SuperAdminContactPage from './pages/SuperAdmin/SuperAdminContactPage/SuperAdminContactPage';
import SuperAdminMockRequests from './pages/SuperAdmin/SuperAdminMockRequests/SuperAdminMockRequests';
import SuperAdminScheduleMockInterview from './pages/SuperAdmin/SuperAdminScheduleMockInterview/SuperAdminScheduleMockInterview';
import SuperAdminAllMockInterviews from './pages/SuperAdmin/SuperAdminAllInterviews/SuperAdminAllMockInterviews';
import InterviewerAllMockInterviews from './pages/Interviewer/InterviewerAllInterviews/InterviewerAllMockInterviews';
import MockInterviewAccessForInterviewer from './pages/Interviewer/InterviewerVideoRoom/MockInterviewAccessForInterviewer';
import MockInterviewAccessForCandidate from './pages/User/CandidateVideoRoom/MockInterviewAccessForCandidate';
import MockInterviewRoom from './pages/Interview/MockInterviewRoom/MockInterviewRoom';
import SuperAdminMockReport from './pages/SuperAdmin/SuperAdminReport/SuperAdminMockReport';
import RecordingVideo from './RecordingVideo';
import RandomCandidateRecordingVideo from './RandomCandidateRecordingVideo';
import CompanyDetailedReport from './pages/Company/CompanyReport/CompanyDetailedReport';
import CookiesConsentPortal from './CookiesConsentPortal';
import UserMockInterviewRequest from './pages/User/UserMockInterviewRequest/UserMockInterviewRequest';
import Chat from './pages/Chat/Chat';
import Error404 from './pages/Error404';
import SuperAdminAllBlog from './pages/SuperAdmin/SuperAdminBlogs/SuperAdminAllBlog';
import SuperAdminNewBlogCreator from './pages/SuperAdmin/SuperAdminBlogs/SuperAdminNewBlogCreator';
import SuperAdminSingleBlogDetails from './pages/SuperAdmin/SuperAdminBlogs/SuperAdminSingleBlogDetails';
  ...
  return (
    <>
        ...
        toastOptions={{
          ...
          warning: {
            style: {
              ...
              boxShadow: "0 2px 16px rgba(245, 158, 11, 0.1)"
            },
            iconTheme: {
              primary: "#f59e0b",
              secondary: "#fffbeb"
      ...
      <Routes>
        ...
        <Route path='/videoroomforMockInterview' element={<MockInterviewAccessForCandidate />} />
        {/* <Route path="/videoroom/:roomId" element={<RoomPageWithZegoCloud />} /> */}
        {/* <Route path="/videoroom/:roomId" element={<RoomPageWithZegoCloud1 />} /> */}
        <Route path="/videoroom/:roomId" element={<NewInterviewRoom />} />
        <Route path="/mockinterviewvideoroom/:roomId" element={<MockInterviewRoom />} />
        <Route path="/recording-video/:encodedKey" element={<RandomCandidateRecordingVideo />} />
        ...
        <Route path="/company" element={
          ...
          <Route path='detailedReport' element={<CompanyDetailedReport />} />
          <Route path="recording-video/:encodedKey" element={<RecordingVideo />} />
          ...
          <Route path='chat-with-superadmin' element={<Chat />} />
          {/* <Route path='chat-with-superadmin' element={<ChatPage />} /> */}
        ...
        <Route path="/superadmin" element={
          ...
          <Route path="notifications" element={<NotificationsPage />} />
          <Route path="allBlog" element={<SuperAdminAllBlog />} />
          <Route path="create-new-blog" element={<SuperAdminNewBlogCreator />} />
          <Route path="blog/:id" element={<SuperAdminSingleBlogDetails />} />
          ...
          <Route path='allMockInterviews' element={<SuperAdminAllMockInterviews />} />
          ...
          <Route path='candidate-mock-report' element={<SuperAdminMockReport />} />
          <Route path='setting' element={<SettingsPage />} />
          ...
          <Route path="recording-video/:encodedKey" element={<RecordingVideo />} />
          <Route path="contacts" element={<SuperAdminContactPage />} />
          <Route path="mockrequests" element={<SuperAdminMockRequests />} />
          {/* <Route path="schedule-mock-interview/:requestId" element={<SuperAdminScheduleMockInterview />} /> */}
          <Route path="schedule-mock-interview" element={<SuperAdminScheduleMockInterview />} />
        ...
        <Route path="/interviewer" element={
          ...
          <Route path='mock-interviews' element={<InterviewerAllMockInterviews />} />
          <Route path='videoroom' element={<InterviewAccessForInterviewer />} />
          <Route path='videoroomforMockInterview' element={<MockInterviewAccessForInterviewer />} />
          <Route path='setting' element={<SettingsPage />} />
        ...
        <Route path="/user" element={
          ...
          <Route path='request-mock-interview' element={<UserMockInterviewRequest />} />
          <Route path='setting' element={<SettingsPage />} />
