                ...
                <div className='widget widget_contact'>
                  <ul className="details space-y-2">
                    <li>
                      ...
                      <span className="fw-bold">Headquarters:</span>
                      75 Chalcombe Close, Little Stoke, Bristol, BS34 6ER, UK
                    </li>
                    ...
                    <li>
                      <a href="tel:+353-892061767" className="flex items-center space-x-2">
                        <FaPhoneAlt className="me-2" />
                        <span>+353-892061767</span>
                      </a>
                    </li>
                    <li>
                      <a href="mailto:info@recruitway.ai" className="flex items-center space-x-2">
                        <FaEnvelope className="mr-2" />
                        <span>info@recruitway.ai</span>
                      </a>
                    </li>
                  </ul>
