...
const ScheduleInterviewWithCV = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            createNotification(job?.companyId, "INTERVIEW_SCHEDULED", `An interview has been scheduled for the position of "${job?.title}" with candidate ${formData?.candidateName || 'a candidate'} via CV.`)
            createNotification(formData?.interviewerId, "INTERVIEW_SCHEDULED", `You have been assigned to conduct an interview for the position of "${job?.title}" for ${job?.company}.`)
