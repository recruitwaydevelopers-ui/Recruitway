...
const UserAllInterviewByJobPost = () => {
    ...
    const fetchInterviews = async () => {
        try {
            setLoading(true);
            const response = await axios.get(`${server}/api/v1/candidate/user-interviews`,
                {
                    headers: {
            ...
            const formattedEvents = response.data.map(interview => ({
                id: interview._id,
                title: `${interview.jobTitle} - ${interview.interviewerName}`,
    ...
    const handleCancelInterview = async () => {
        setLoading(true);
        try {
            const res = await axios.put(`${server}/api/v1/candidate/${selectedEvent.id}/cancel`,
                {},
                {
                    headers: {
                        Authorization: `Bearer ${token}`
    ...
    const getLocationIcon = (location) => {
        switch (location) {
            case 'googleMeet': return 'bi bi-google';
            case 'zoom': return 'bi bi-camera-video';
            case 'inPerson': return 'bi bi-geo-alt';
            case 'phone': return 'bi bi-telephone';
            default: return 'bi bi-calendar-event';
        }
    };

    const handleStartInterview = () => {
        navigate('/user/videoroom', { state: { id: selectedEvent.interviewId } });
    };
            ...
            <div className="container">
                <div className="card">
                    <div className="card-header d-flex justify-content-between align-items-center">
                        <h2 className="mb-0">My Interviews</h2>
                    </div>
                        ...
                        <div className="modal-dialog modal-lg">
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    ...
                                    <div className="row mb-3">
                                        <div className="col-md-6">
                                            ...
                                            <p>
                                                <i className={getLocationIcon(selectedEvent.location) + ' me-2'}></i>
                                ...
                                <div className="modal-footer">
                                    ...
                                    {/* {selectedEvent.status === 'scheduled' && (
                                        <Link to={`/user/videoroom/${selectedEvent.interviewId}`} className="btn btn-secondary">Start</Link>
                                    )} */}
                                    {selectedEvent.status === 'scheduled' && (
...
export default UserAllInterviewByJobPost;