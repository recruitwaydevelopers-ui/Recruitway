...
mockInterviewReportSchema.virtual('completionPercentage').get(function () {
    return Math.round((this.questionsAnswered / this.totalQuestions) * 100);
});

// Add a method to calculate average skill score
mockInterviewReportSchema.methods.getAverageSkillScore = function () {
...
mockInterviewReportSchema.pre('save', function (next) {
...
// Create the model
const MockReport = model('MockReport', mockInterviewReportSchema);
