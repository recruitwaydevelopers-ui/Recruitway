...
const SuperAdminSendInterviewLinkModalForCV = ({ isOpen, interview, onClose }) => {
    ...
    const { getAllInterviewsByCV, handleSendEmailForCV } = useSuperAdminContext()
...
RecruitWay`);
    ...
    const handleSend = async () => {
        ...
        setIsSending(true);
        try {
            await handleSendEmailForCV(interview._id, {
                email,
                interviewerEmail,
                emailSubject,
                emailMessage,
...
export default SuperAdminSendInterviewLinkModalForCV;