...
export const Candidate = () => {
  ...
  const handleLinkedinLogin = async () => {
    try {
      const { data } = await axios.get(`${server}/api/v1/auth/linkedin?role="user"`);
      if (data.authUrl) {
          ...
          <div className='row align-items-center wow animated ' data-aos='fade-up' data-aos-delay='100' data-aos-duration='1500'>
            <div className='col-lg-6 d-flex'>
              <div className='section-title mb-0'>
                ...
                <Link className='btn btn-border-base' to='/TechInterviewPage'>Book your interview</Link>
              </div>
            </div>
        ...
        <div className='container pd-bottom-60'>
          ...
          <div className="row reques-demo-main">
            < div className="col-lg-3 text-center">
              <Link className='btn btn-border-base' to='/TechInterviewPage'>Take mock interview</Link>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className='row align-items-center wow animated ' data-aos='fade-up' data-aos-delay='100' data-aos-duration='1500'>
            ...
            <div className='col-lg-6 d-flex'>
              <div className='section-title mb-0'>
                ...
                <Link className='btn btn-border-base' to='/TechInterviewPage'>
                  Book your interview
                </Link>
              </div>
            </div>
