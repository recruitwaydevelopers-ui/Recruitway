...
const getProfile = async (req, res) => {
    ...
    try {
        const pro = await InterviewerProfile.findOne({ userId });
...
const getInterviewerMockInterviews = async (req, res) => {
...
const cancelMockInterview = async (req, res) => {
    const _id = req.params.id;
    const interviewerId = req.user._id;

    try {
        const interview = await MockInterviews.findOne({
            _id: _id,
            interviewerId: interviewerId
        })
...
module.exports = {
    createOrUpdateProfile, getProfile, getInterviewerInterviews, getInterviewerInterviewsbycv, getInterviewerMockInterviews,
    cancelInterview, cancelMockInterview, getInterviewDetailsForInterviewer, generateTokenForInterviewer,
};
