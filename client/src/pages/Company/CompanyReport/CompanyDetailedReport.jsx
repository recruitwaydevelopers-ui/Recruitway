...
const CompanyDetailedReport = () => {
    const { isLoading, getInterviewReport } = useCompanyContext();
            ...
            const fetchReport = async () => {
                try {
                    ...
                    if (report) {
                        ...
                        setError("No report available for this interview.");
                    }
                } catch (err) {
                    setError("Unexpected error occurred while fetching report.");
    ...
    const handleVideo = () => {
        if (reportData?.url?.key) {
            navigate(`/company/recording-video/${encodeURIComponent(reportData.url.key)}`);
        } else {
            ...
            <div className="container">
                ...
                <div id="print-area" className="main">
                    ...
                    <div className="card mb-4 shadow-sm">
                        ...
                        <div className="card-body">
                            <a href={`/company/recording-video/${encodeURIComponent(reportData.url.key)}`} className="small">{reportData.url.key}</a>
                        </div>
...
export default CompanyDetailedReport;