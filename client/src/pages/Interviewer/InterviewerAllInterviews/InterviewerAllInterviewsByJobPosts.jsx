...
const InterviewerAllInterviewsByJobPosts = () => {
    ...
    const fetchInterviews = async () => {
        try {
            setLoading(true);
            const response = await axios.get(`${server}/api/v1/interviewer/getInterviewerInterviews`,
                {
                    headers: {
            ...
            <div className="container">
                <div className="card">
                    <div className="card-header d-flex justify-content-between align-items-center">
                        <h2 className="mb-0">All Scheduled Interview By Job Posts</h2>
                    </div>
...
export default InterviewerAllInterviewsByJobPosts;