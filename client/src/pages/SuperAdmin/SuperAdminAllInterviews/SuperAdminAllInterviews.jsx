...
const SuperAdminAllInterviews = () => {
    ...
    const cancelledCount = interviewes.filter(i => i.status === 'cancelled').length;

    const inprocessCount = interviewes.filter(i => i.status === 'inProcess').length;
        ...
        <>
            <div className="container-fluid">
                <div className="container">
                    <h1 className="mb-4">Job Post Interview Management</h1>
                                                ...
                                                <td>
                                                    <div className="d-flex flex-wrap gap-2">
                                                        ...
                                                        {activeTab === 'completed' && (
                                                            ...
                                                            {/* <button className="btn btn-sm btn-success" onClick={() => navigate("/superadmin/candidate-detailed-report", { state: { id: interview.interviewId } })}>
                                                                Get Detailed Report
                                                            </button> */}
                                                            </>
                                                        )}
