...
const ReportForm1 = ({ isVisible, onClose, roomId, token, server, recordingUrl }) => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const res = await axios.post(
                `${server}/api/v1/interviews/updateStatusandSubmitReport/${roomId}`,
                { reportData: formData },
    ...
    return (
        <div className="report-form-container">
                    ...
                    <div className="drawer-body">
                        {activeTab === 'form' ? (
                            ...
                            <div className="report-view">
                                        ...
                                        <div className="card">
                                            <div className="card-body">
                                                ...
                                                <div className="card-text">
                                                    <p><span className="text-muted">Name:</span> {generatedReport.candidateName}</p>
                                                    <p><span className="text-muted">Email:</span> {generatedReport.candidateEmail}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-12">
                                        <div className="card">
                                            <div className="card-body">
                                                ...
                                                <div className="card-text">
                                                    <p><span className="text-muted">Position:</span> {generatedReport.positionTitle}</p>
                                                    <p><span className="text-muted">Date:</span> {new Date(generatedReport.interviewDate).toLocaleString()}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="row gap-3">
                                            <div className="col-12">
                                                ...
                                                <p className="metric-value">{generatedReport.overallScore}/10</p>
                                            </div>
                                            <div className="col-12">
                                                <p className="text-muted mb-1">Questions</p>
                                                <p className="metric-value">{generatedReport.questionsAnswered}/{generatedReport.totalQuestions}</p>
                                            </div>
                                            <div className="col-12">
                                                <p className="text-muted mb-1">Duration</p>
                                                <p className="metric-value">{generatedReport.duration} min</p>
                                            </div>
                                            <div className="col-12">
                                ...
                                {/* Recording Section */}
                                {generatedReport.recordingUrl && (
                                    <div className="card mb-4">
                                        <div className="card-body">
                                            <h2 className="card-title">Recording</h2>
                                            <div className="mb-3">
                                                <p className="text-muted mb-1">Interview Recording</p>
                                                <a
                                                    href={generatedReport.recordingUrl}
                                                    target="_blank"
            ...
            <style>{`
                ...
                .preview-button, .submit-button, .edit-button, .close-report-button {
