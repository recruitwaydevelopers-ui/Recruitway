...
const InterviewAccessForCandidate = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log(err.message || 'Failed to verify access');
    ...
    const verifyAccessDetails = async (interviewId) => {
        try {
            const response = await axios.post(`${server}/api/v1/interviews/verify-access-for-candidate`,
                { interviewId },
                {
                    headers: {
...
export default InterviewAccessForCandidate;
