...
const MockInterviewAccessForInterviewer = () => {
    ...
    const verifyAccessDetails = async (interviewId) => {
        try {
            const response = await axios.post(`${server}/api/v1/interviews/verify-access-0f-interviewer-for-mock-interviewer`,
                { interviewId },
                {
                    headers: {
...
export default MockInterviewAccessForInterviewer;
