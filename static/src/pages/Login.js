...
export const Login = () => {
  return (
    <>
     {/* Navigation Bar*/}
      <NavbarTwo/>
    <div className="d-flex min-vh-100 align-items-center justify-content-center pd-top-60 pd-bottom-60 bg-color-btn">
                    {/* Login Card */}
                        ...
                        <div className="card border-0 shadow-lg rounded-3 overflow-hidden">
                            ...
                            <div className="card-body p-4 p-md-5">
                                ...
                                <form className="needs-validation" noValidate>
                                    ...
                                    {/* Submit Button */}
                                    <button type="submit" className="btn btn-primary w-100 py-2 mb-3 fw-medium" >Sign In</button>
                                    {/* Divider */}
