...
// const InterviewerAllMockInterviews = () => {
...
//         try {
//             setLoading(true);
//             const response = await axios.get(`${server}/api/v1/interviewer/getInterviewerMockInterviews`,
//                 {
//                     headers: {
...
// export default InterviewerAllMockInterviews;
...
const InterviewerAllMockInterviews = () => {
    ...
    const fetchInterviews = async () => {
        try {
            ...
            // Format events based on the new API response structure
            const formattedEvents = response.data.map(interview => ({
                id: interview._id,
                title: `${interview.profile} - ${interview.candidateName}`,
                start: interview.start,
                end: interview.end,
                interviewId: interview.interviewId,
                extendedProps: {
                    ...
                    interviewerChoice: interview.interviewerChoice,
    ...
    const handleCancelInterview = async () => {
        setLoading(true);
        try {
            const res = await axios.put(`${server}/api/v1/interviewer/${selectedEvent.id}/cancel-mock`,
                {},
                {
                    headers: {
                        Authorization: `Bearer ${token}`
    ...
    const handleStartInterview = () => {
        navigate('/interviewer/videoroomforMockInterview', { state: { id: selectedEvent.interviewId } });
    };
    ...
    return (
        <div className="container-fluid">
            <div className="container">
                <div className="card">
                    <div className="card-header d-flex justify-content-between align-items-center">
                        <h2 className="mb-0">All Scheduled Mock Interviews</h2>
                    </div>
                    <div className="card-body">
                        {error && (
                            <div className="alert alert-danger" role="alert">
                        ...
                        <div className="modal-dialog modal-lg">
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    <div className="row mb-3">
                                        <div className="col-md-8">
                                            <h4>{selectedEvent.profile}</h4>
                                            <p className="text-muted">{selectedEvent.interviewerChoice}</p>
                                        </div>
                                        <div className="col-md-4 text-end">
                                            <span className={`badge ${selectedEvent.status === 'scheduled' ? 'bg-primary' :
                                                selectedEvent.status === 'confirmed' ? 'bg-info' :
                                    ...
                                    <div className="row mb-3">
                                        <div className="col-md-6">
                                            ...
                                            <p>
                                                ...
                                                <strong>Email:</strong> {selectedEvent.candidateEmail}
                                            </p>
                                            <p>
                                                <i className="bi bi-telephone me-2"></i>
                                                <strong>Phone:</strong> {selectedEvent.candidatePhone}
                                            </p>
                                            <p>
                                                <i className="bi bi-person-badge me-2"></i>
                                                <strong>Interviewer:</strong> {selectedEvent.interviewerName}
                                            </p>
                                        </div>
                                        <div className="col-md-6">
                                            <p>
                                            ...
                                            <p>
                                                ...
                                                <strong>Experience Level:</strong> {selectedEvent.experienceLevel}
                                            </p>
                                            <p>
                                                <i className="bi bi-building me-2"></i>
                                                <strong>Company Preference:</strong> {selectedEvent.interviewerChoice}
                                            </p>
                                        </div>
                                    </div>
