            ...
            <div>
                ...
                <nav className="sidebar-nav mt-5" data-simplebar>
                    <ul id="sidebarnav">
                        ...
                        <li className="sidebar-item">
                            <Link className="sidebar-link" to="/interviewer/mock-interviews" aria-expanded="false">
                                <span><i className="ti ti-microphone"></i></span>
                                <span className="hide-menu">Mock Interviews</span>
                            </Link>
                        </li>

                        {/* Optional extra features if enabled later */}
                        ...
                        {/* <li className="sidebar-item">
                            <Link className="sidebar-link" to="/interviewer/InterviewFormate" aria-expanded="false">
                                ...
                                <span className="hide-menu">Interview Format</span>
                            </Link>
                        </li>
                        ...
                        <li className="sidebar-item">
                            <Link className="sidebar-link" to="/interviewer/PostInterviewActions" aria-expanded="false">
                                <span><i className="ti ti-checks"></i></span>
                                <span className="hide-menu">Post Interview Actions</span>
                            </Link>
                        </li>

                        <li className="sidebar-item">
                            <Link className="sidebar-link" to="/interviewer/IntegrationTools" aria-expanded="false">
                                <span><i className="ti ti-plug"></i></span>
