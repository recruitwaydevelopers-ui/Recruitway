          ...
          <div className='row'>
            <div className='col-lg-6 align-self-center' data-aos='fade-up' data-aos-delay='100' data-aos-duration='1500'>
              <div className="main-btnhome pd-bottom-30">
                <div
                  className='subtitle set-space-top set-space-top-org ORGANIZATIONS-res'>
                  <h6>ORGANIZATIONS</h6>
                </div>
                <div className='subtitle set-space-top-btn'>
                  <h6><Link to='/Candidate'>CANDIDATES <svg xmlns="http://www.w3.org/2000/svg" width="18" height="10" viewBox="0 0 18 12" fill="none" transform="rotate(-45)"><path d="M1 6H17M17 6L12 1M17 6L12 11" stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path></svg></Link></h6>
                </div>
                <div className='subtitle set-space-top-btn'>
                  <h6><Link to='/Interviewers'>JOIN AS INTERVIEWER <svg xmlns="http://www.w3.org/2000/svg" width="18" height="10" viewBox="0 0 18 12" fill="none" transform="rotate(-45)"><path d="M1 6H17M17 6L12 1M17 6L12 11" stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path></svg></Link></h6>
                </div>
              </div>
