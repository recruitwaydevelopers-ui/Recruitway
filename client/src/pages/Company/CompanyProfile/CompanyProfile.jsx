                ...
                <div className="col-12 col-xl-10">
                    <div className="mb-4 d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                        <div className="mb-3 mb-md-0">
                            <h2 className="fw-bold mb-1">Company Profile Settings</h2>
                            <p className="text-muted mb-0">Manage your company information and profile details</p>
                        </div>
                                ...
                                <div className="row g-4">
                                    ...
                                    <div className="col-12 col-lg-4">
                                        <div className="d-flex flex-column align-items-center mb-4">
                                            <img
                                                src={preview || company?.profilePicture || 'https://ui-avatars.com/api/?name=' + (company?.fullname || 'Company') + '&size=200&background=0D8ABC&color=fff'}
                                                alt="Company Logo"
                                            ...
                                            {editMode && (
                                                <>
                                                    ...
                                                    <p className="text-muted small mt-1">
                                                        Click above to upload a new company logo
                                                    </p>
                                                </>
                                            )}
                                        </div>
                                        <div className="mt-3 text-center">
                                            <h5 className="fw-semibold mb-1">{company?.fullname || "Company Name"}</h5>
                                            <p className="text-muted small mb-0">{company?.tagline}</p>
                                        </div>
                                    </div>
                    ...
                    <div className="card border-0 shadow-sm mt-4">
                        <div className="card-body p-4">
                            <div className="d-flex justify-content-between align-items-center mb-4">
                                <h5 className="fw-semibold mb-0">Key Details</h5>
                                {editMode && (
                                    <button
                                        type="button"
                                        className="btn btn-sm btn-primary"
                                    ...
                                    <div key={index} className="col-md-6">
                                        {editMode ? (
                                            ...
                                            <div className="p-2 bg-light rounded mb-2">
                                                <div className="fw-medium">{detail?.key || 'Key'}</div>
                                                <div className="text-muted small">{detail?.value || 'Value'}</div>
                                            </div>
                                        )}
                                    </div>
                                ))}
                    ...
                    <div className="card border-0 shadow-sm mt-4">
                        <div className="card-body p-4">
                            <h5 className="fw-semibold mb-4">Leadership</h5>
                            <div className="row g-4">
                            ...
                            <div className="row g-3">
                                ...
                                <div className="col-md-4">
                                    ...
                                    {editMode ? (
                                        ...
                                        <div className="p-2 bg-light rounded">
                                            {company?.contactEmail ? (
                                                <a href={`mailto:${company.contactEmail}`} className="text-primary">
                                                    {company.contactEmail}
                                                </a>
                                            ) : (
                                                "Not provided"
                                ...
                                <div className="col-md-4">
                                    ...
                                    {editMode ? (
                                        ...
                                        <div className="p-2 bg-light rounded">
                                            {company?.contactPhone ? (
                                                <a href={`tel:${company.contactPhone}`} className="text-primary">
                                                    {company.contactPhone}
                                                </a>
                                            ) : (
                                                "Not provided"
                    ...
                    <div className="card border-0 shadow-sm mt-4">
                        <div className="card-body p-4">
                            <div className="d-flex justify-content-between align-items-center mb-4">
                                <h5 className="fw-semibold mb-0">Company History</h5>
                                {editMode && (
                                    <button
                                        type="button"
                                        className="btn btn-sm btn-primary"
                    ...
                    <div className="card border-0 shadow-sm mt-4">
                        <div className="card-body p-4">
                            <div className="d-flex justify-content-between align-items-center mb-4">
                                <h5 className="fw-semibold mb-0">Additional Details</h5>
                                {editMode && (
                                    <button
                                        type="button"
                                        className="btn btn-sm btn-primary"
                    ...
                    <div className="card border-0 shadow-sm mt-4">
                        <div className="card-body p-4">
                            <div className="d-flex justify-content-between align-items-center mb-4">
                                <h5 className="fw-semibold mb-0">Departments</h5>
                                {editMode && (
                                    <button
                                        type="button"
                                        className="btn btn-sm btn-primary"
                                ...
                                {company?.departments?.map((dept, index) => (
                                    <div key={index} className="col-md-6">
                                        {editMode ? (
                                            ...
                                            <div className="p-2 bg-light rounded mb-2">
                                                <div className="fw-medium">{dept?.key || 'Department'}</div>
                                                {dept?.value && <div className="text-muted small">{dept?.value}</div>}
                                            </div>
                                        )}
                                    </div>
                                ))}
                    ...
                    <div className="card border-0 shadow-sm mt-4">
                        <div className="card-body p-4">
                            <div className="d-flex justify-content-between align-items-center mb-4">
                                <h5 className="fw-semibold mb-0">Office Locations</h5>
                                {editMode && (
                                    <button
                                        type="button"
                                        className="btn btn-sm btn-primary"
                                    ...
                                    <div key={index} className="mb-4 pb-3 border-bottom">
                                        {editMode ? (
                                            ...
                                            <div className="d-flex align-items-center">
                                                <i className="ti ti-map-pin me-3 text-danger" style={{ fontSize: '1.5rem' }}></i>
                                                <div>
                                                    <h5 className="h6 mb-1">{location?.city || 'City'}</h5>
                                                    <p className="text-muted mb-0">{location?.country || 'Country'}</p>
                                                </div>
                                            </div>
                                        )}
                                ...
                                <div className="col-12 col-md-6">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <p className="fw-medium mb-0">Company</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-12 col-md-6">
