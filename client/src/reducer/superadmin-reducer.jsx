const superAdminReducer = (state, action) => {
    switch (action.type) {
        ...
        case "SET_ALL_MOCK_INTERVIEWS_OF_ALL_CANDIDATES":
            return {
                ...state,
                isLoading: false,
                mockinterviewes: action.payload
            }
        ...
        case "SET_MOCK_REPORT_OF_CANDIDATE":
            return {
                ...state,
                isLoading: false,
                mockReport: action.payload
            }

        case "SET_DETAILED_REPORT_OF_CANDIDATE":
            return {
                ...state,
                isLoading: false,
                detailedReport: action.payload.detailedReport,
                aiReport: action.payload.aiReport
            }
