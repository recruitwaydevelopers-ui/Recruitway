...
const InterviewAccessForRandomCandidate = () => {
    ...
    const verifyAccessDetails = async (interviewId) => {
        try {
            const response = await axios.post(`${server}/api/v1/interviews/verify-access-for-random-candidate`,
                { interviewId }
            );
...
export default InterviewAccessForRandomCandidate;
